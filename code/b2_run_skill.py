...
from common.path_utils import DEFAULT_B2_OUTPUT_ROOT,DEFAULT_DATA_ROOT, bootstrap_project_root, resolve_cli_path
from common.schemas import make_skill_result
from common.errors import error_to_dict
...
SKILL_MODULES = {
    ...
    "audio_preprocess": "skills.audio_preprocess",
    "speech_to_text": "skills.speech_to_text",
    "text_to_speech": "skills.text_to_speech",
}
...
def run_skill(skill_name: str, input_data: dict, data_root: str | None = None, output_dir: str | None = None) -> dict:
    ...
    if "output_dir" in signature.parameters:
        kwargs["output_dir"] = output_dir or str(DEFAULT_B2_OUTPUT_ROOT)
    start = perf_counter()
    try:
