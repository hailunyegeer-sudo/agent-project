...
@tool(
    ...
    parameters={
        "path": "Table path relative to data root.",
        "max_rows_preview": "Number of preview rows.",
        "describe": "Whether to calculate numeric statistics.",
    },
    returns={
